								...
								<ul class="sub-menu">
									<li>
										<a href="doctor-specilization.php">
											<span class="title"> Especialización médica</span>
										</a>
									</li>
									<li>
										<a href="add-doctor.php">
											<span class="title"> Añadir Doctor</span>
										</a>
									</li>
									<li>
	...
	<li>
								<a href="doctor-logs.php">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Doctor sesión registros </span>
										</div>
									</div>
								</a>
							</li>		
							...
							<li>
								<a href="user-logs.php">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title">Registro de sesión de usuarios </span>
										</div>
									</div>
								</a>
							</li>
