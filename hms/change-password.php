				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
							...
							<input type="password" name="cpass" class="form-control"  placeholder="escriba password actual">
														</div>
														<div class="form-group">
...
<div class="form-group">
									...
									<input type="password" name="cfpass" class="form-control"  placeholder="Confirmar Password">
														</div>
